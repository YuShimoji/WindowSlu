...
#### 🆕 グループ一括制御
- **グループ透明度スライダー**: グループヘッダーのOpacityスライダーでグループ内全ウィンドウの透明度を一括変更
- **グループサイズ設定**: グループヘッダーでサイズ（幅×高さ）を入力し、Applyボタンでグループ内全ウィンドウに適用

#### 🆕 ドラッグ&ドロップ
- **ウィンドウの移動**: ウィンドウをドラッグして別のグループにドロップすると、そのグループに移動します
- **簡単なグループ編集**: 手動でウィンドウのグループ割り当てを変更可能
